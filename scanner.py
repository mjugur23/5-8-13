...
SYMBOLS = [
    ...
    "SISE","KRDMD","BRISA","ALGYO","NETAS","SKBNK","TSKB","ALARK",
    "KLRHO","BINHO","GSRAY","FENER","BJKAS","TKFEN","RTALB","MPARK",
    "LOGO","INDES","DOHOL","CIMSA","OYAKC","BOLUC","ADANA","ADEL",
    "AKENR","AKFEN","AKGRT","ALFAS","ALKIM","ANELE","ASUZU","AVHOL",
    "AYEN","BASGZ","BFREN","BIOEN","BIZIM","BNTAS","BORSK","BSOKE",
    "BTCIM","BUCIM","BURCE","BURVA","BVSAN","CANTE","CELHA","CLEBI",
    "DENGE","DEVA","DGKLB","DITAS","DMSAS","DOBUR","DURDO","DYOBY",
    "ECZYT","EDIP","EGEEN","EGGUB","EKIZ","EMKEL","EMNIS","EPLAS",
    "ERSU","ESCOM","ESEN","EUPWR","FLAP","FONET","FRIGO","GENTS",
    "GEREL","GLYHO","GOLTS","GOODY","GSDHO","GUNDG","HATEK","HEDEF",
    "HEKTS","HLGYO","HOROZ","HRKET","HTTBT","HUNER","IHAAS","IPEKE",
]
